  ...
  return (
    ...
    >
      <div className="relative flex size-36 items-center justify-center sm:size-44">
        <div
          className="absolute inset-[-8%] rounded-full motion-safe:animate-[star-wave_4.5s_ease-in-out_infinite]"
          style={{
            background:
        ...
        />
        <div
          className="absolute inset-[-22%] rounded-full motion-safe:animate-[star-wave_5.2s_ease-in-out_infinite]"
          style={{
            animationDelay: "1.4s",
            background:
        ...
        />
        <svg
          className="relative z-10 size-24 motion-safe:animate-[star-pulse_3.6s_ease-in-out_infinite] sm:size-28"
          viewBox="0 0 64 64"
          fill="none"
        >
          <defs>
